...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      function AppComponent(http, cookieService) {
        ...
        this.order = {}; // this.http.get("me").subscribe(data=>{ 现在改成cookie获取 那么这个方法不能使用了，我们直接请求到网关服务器进行认证
        ...
        this.http.get("api/user/me").subscribe(function (data) {
          ...
          if (!_this.authenticated) {
            ...
            +"&redirect_uri=http://admin.security.com:7027/oauth/callback" + "&state=ABC"; //这个是盐 标识一个状态，比如在某一步跳转到了登录认证，回来的时候会原样回来，那么 就可以通过这个字符串 恢复之前跳转的页面
          }
        });
      } //方法
  ...
  function srcAppAppInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "RefreshInterceptor", function () {
    ...
    function () {
      function RefreshInterceptor(http) {
        _classCallCheck(this, RefreshInterceptor);

        this.http = http;
      }

      _createClass(RefreshInterceptor, [{
        key: "intercept",
    ...
    RefreshInterceptor.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]
      }];
    };

    RefreshInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], RefreshInterceptor);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_interceptor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./app.interceptor */
    "./src/app/app.interceptor.ts");
    /* harmony import */
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\git\20191206\security-api-admin\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
