package com.my.security.spikappoval;
...
/**
 * 去掉授权页面 直接跳转 ，直接重写 直接submit
 * 
 * @author Administrator
 *
 */
//@FrameworkEndpoint 比@RestController 级别低 如果重写 了 mvc 会调用restController
@RestController
@SessionAttributes("authorizationRequest")
public class SSOApprovalEnpoit {
